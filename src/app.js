...
async function loadMaps(){
    ...
    await fetchMap(2017);
    await fetchMap(2018);
    setTimeout(function(){ map.addLayer(vectorLayer); }, 18000);
}
...
function fetchMap(year){
    fetch('https://tiles.arcgis.com/tiles/nSZVuSZjHpEZZbRo/arcgis/rest/services/Historische_tijdreis_'+year+'/MapServer/WMTS/1.0.0/WMTSCapabilities.xml').then(function(response) {
        ...
        var tileLayer = new ol.layer.Tile({
            ...
            title: year,
            baseLayer: true,
            source: new ol.source.WMTS( /** @type {!module:ol/source/WMTS~Options} */ (options))
        });
